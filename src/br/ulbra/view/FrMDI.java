 ...
 * @author s.lucas
 */
public class FrMDI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrMDI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
